...
contract RPS {
    ...
    enum Move {
        ...
        Spock,
        Lizard
    } // Possible moves. Note that if the parity of the moves is the same the lower one wins, otherwise the higher one.
    ...
    function win(Move _c1, Move _c2) constant returns (bool w) {
        ...
        // They did not play.
        else if (uint256(_c1) % 2 == uint256(_c2) % 2) return (_c1 < _c2);
        else return (_c1 > _c2);
    }
}
